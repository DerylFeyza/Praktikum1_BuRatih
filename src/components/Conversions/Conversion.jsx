...
function Conversion() {
	...
	const handleConvert = () => {
		const result = ConversionHandler.handleConvert(bilangan, tobilangan, value);
		setResult(result);
	};

	return (
		<>
			<div className="ConversionForm container mt-5">
				<div className="initialform">
					<h2 className="mb-4">Konversi Bilangan Calculator</h2>
